...
local langArray =  { --by Kwisatz
    ...
    ["ERRORpackMissing"]    = ADDON_NAME .. ": Pas de nom de profil",
    ...
    ["deletePackAlert"]     = ADDON_NAME .. ": Vous devez sélectionner un profil à supprimer.",
    ["deletePackError"]     = ADDON_NAME .. ": Erreur de suppression du profil\n%s.",
