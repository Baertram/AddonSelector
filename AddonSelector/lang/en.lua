...
local langArray = {
    ...
    ["UndoLastMassMarking"] = "< Undo to last marked backup",
    ["ClearLastBeforeDisableAllMarking"] = "Clear \'Disable all & ReloadUI\' backup",
    ["UndoLastBeforeDisableAllMarking"] = "< Undo to before \'Disable all & ReloadII\'",
    ["ClearLastMassMarking"] = "Clear last marked backup",
