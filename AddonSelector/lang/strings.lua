...
---------------------------------------------------------------------------------------------------------------------
    ...
    ["tr"] = { -- Circonian ve Baertram tarafından
        ["packName"] = "Paket adı:",
        ["selectPack"] = "Seç",
...
langArray["fx"] = langArray["pl"] --unofficial pl "debug language" -> by generaluploads
langArray["kr"] = langArray["en"] --official untranslated language to prevent errors
langArray["kb"] = langArray["en"] --unofficial kr "debug language"
langArray["tb"] = langArray["tr"] --unofficial tr "debug language"
